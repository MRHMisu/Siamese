...
/**
 * A builder class that helps to build CSharpParser with Custom Error Listener
...
public final class Builder {
    ...
    public static final class Parser {
        ...
        public Parser(CharStream input) {
            ...
            this.parser = new CSharpParser(new CommonTokenStream(lexer));
            this.parser.removeErrorListeners();
            this.parser.addErrorListener(ERROR_LISTENER);
        }

        /**
         * Constructor to Create Parser with CSharpLexer
         *
         * @param lexer CSharpLexer;
         */
        public Parser(CSharpLexer lexer) {
            this.parser = new CSharpParser(new CommonTokenStream(lexer));
            this.parser.removeErrorListeners();
            this.parser.addErrorListener(ERROR_LISTENER);
        }
        ...
        /**
         * Build CSharpParser Parser
         *
         * @return CSharpParser Parser
         */
